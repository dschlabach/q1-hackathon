  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <button
        ...
        className="mb-4 bg-gray-800 text-green-400 border border-green-400 py-2 px-6 rounded-md hover:bg-green-400 hover:text-gray-900 transition-all duration-200 shadow-[0_0_15px_rgba(74,222,128,0.2)] hover:shadow-[0_0_20px_rgba(74,222,128,0.4)]"
      >
        Create New Agent
      </button>
          ...
          <div className="max-h-[60vh] overflow-y-auto">
            {agents?.map((agent) => (
              <div
                ...
                className={`bg-gray-800 p-3 rounded-lg shadow-lg mb-4 flex items-center justify-between border-2 transition-all duration-200 cursor-pointer
                ${
